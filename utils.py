...
def preprocess_data(X, columns, objects):
	#sorted columns list
	original_column_order = np.array(["dst_port","flow_duration", "tot_fwd_pkts", "tot_bwd_pkts", "totlen_fwd_pkts", 
